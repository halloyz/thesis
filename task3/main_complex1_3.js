...
let { viewer, panner, stereoPanner, filter, gain, audioCtx, audioElement, vocalElement, successElement, listener } = E.funcs.initialize(cases[c].task3.imageId);
...
const initPromise = new Promise(function(resolve,reject){
    viewer.getPosition()
        .then (async function (pos){
            ...
            E.funcs.getRoute(p.lng, p.lat, cases[c].task3.targetLng, cases[c].task3.targetLat)
